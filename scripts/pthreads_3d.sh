...
echo "Computing a 10x10x10 matrix using Pthreads with 64 threads:"
{ time ../executables/pthreads_3d 64 10 ls -l >/dev/null; } 2>&1 | grep real
...
echo "Computing a 20x20x20 matrix using Pthreads with 64 threads:"
{ time ../executables/pthreads_3d 64 20 ls -l >/dev/null; } 2>&1 | grep real
...
echo "Computing a 30x30x30 matrix using Pthreads with 64 threads:"
{ time ../executables/pthreads_3d 64 30 ls -l >/dev/null; } 2>&1 | grep real
...
echo "Computing a 100x100x100 matrix using Pthreads with 64 threads:"
{ time ../executables/pthreads_3d 64 100 ls -l >/dev/null; } 2>&1 | grep real

# 250 x 250 matrix

echo ""

echo "Computing a 250x250x250 matrix using Pthreads with 1 thread:"
{ time ../executables/pthreads_3d 1 250 ls -l >/dev/null; } 2>&1 | grep real

echo "Computing a 250x250x250 matrix using Pthreads with 2 thread:"
{ time ../executables/pthreads_3d 2 250 ls -l >/dev/null; } 2>&1 | grep real

echo "Computing a 250x250x250 matrix using Pthreads with 4 threads:"
{ time ../executables/pthreads_3d 4 250 ls -l >/dev/null; } 2>&1 | grep real

echo "Computing a 250x250x250 matrix using Pthreads with 8 threads:"
{ time ../executables/pthreads_3d 8 250 ls -l >/dev/null; } 2>&1 | grep real

echo "Computing a 250x250x250 matrix using Pthreads with 64 threads:"
{ time ../executables/pthreads_3d 64 250 ls -l >/dev/null; } 2>&1 | grep real
